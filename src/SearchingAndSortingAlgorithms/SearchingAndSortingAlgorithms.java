...
//	List<Double> peeps = Arrays.asList(new Double[] { 5.7, 6.2, 3.4, 6.2, 5.0, 5.5, 4.7, 6.2, 3.4, 20.8, 4.2, 5.0, 4.5, 5.1, 6.6 });
	//assertEquals(20.8, Algorithms.findTallest(peeps), 0.0);
	//}
...
//	@Test
	...
	//List<String> UnsortedSequences = Arrays.asList(new String[] { "ACTGACTG", "ACTGA", "ACTG"});
	//List<String> SortedSequences = Arrays.asList(new String[] { "ACTG", "ACTGA", "ACTGACTG"});
